        ...
        <Card className="border-border/50 bg-card/60 backdrop-blur">
          <CardHeader className="flex-row items-center gap-3 space-y-0">
            ...
            <div>
              ...
              <CardDescription>
                Live membership snapshot, polled every {interval / 1000}s.
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card className="border-border/50 bg-card/60 backdrop-blur">
          <CardHeader className="flex-row items-center gap-3 space-y-0">
            ...
            <div>
              ...
              <CardDescription>
                SWIM-style probe accounting and recovery counters.
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent>
            ...
            {heartbeat.error && (
              <ErrorState message={(heartbeat.error as Error).message} />
            )}
        ...
        <Card className="border-border/50 bg-card/60 h-full backdrop-blur">
          <CardHeader className="flex-row items-center gap-3 space-y-0">
            ...
            <div>
              ...
              <CardDescription>
                Vnode distribution across owners.
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent>
            ...
            {ring.error && (
              <ErrorState message={(ring.error as Error).message} />
            )}
