    ...
    <Card className="border-border/50 bg-card/60 backdrop-blur">
      <CardHeader className="flex-row items-center gap-3 space-y-0">
        ...
        <div>
          ...
          <CardDescription>
            Who you are, from the iron-session cookie.
          </CardDescription>
        </div>
      </CardHeader>
      <CardContent>
        ...
        >
          <li className="border-border/50 bg-card/50 rounded-lg border p-3">
            ...
            <p className="text-foreground mt-1.5 font-mono text-lg font-semibold">
              {identity}
            </p>
          </li>
          <li className="border-border/50 bg-card/50 rounded-lg border p-3">
        ...
        <p className="text-muted-foreground mt-4 text-xs">
          The bearer token sealing this session is HMAC-encrypted in the cookie
          and intentionally never surfaced here — exposing it (even masked)
          would create a screen-scrape vector.
        </p>
      </CardContent>
    </Card>
  );
