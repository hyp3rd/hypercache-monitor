...
const distMetricsFixture = {
  ...
  HintedBytes: 4096,
  MigrationHintQueued: 4,
  MigrationHintReplayed: 4,
  MigrationHintExpired: 0,
  MigrationHintDropped: 0,
  MigrationHintLastAgeNanos: 1_200_000,
  MerkleSyncs: 10,
  MerkleKeysPulled: 8,
  ...
  AutoSyncLoops: 50,
  AutoSyncCleanTicks: 12,
  AutoSyncBackoffFactor: 1,
